...
_See code: [src/commands/connectors/create-git.ts](https://github.com/ldhertert/harness-automation/blob/v1.0.0-alpha/src/commands/connectors/create-git.ts)_
